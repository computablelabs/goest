...
func DeployConstructableBasic(auth *bind.TransactOpts, backend bind.ContractBackend, initialAccount common.Address, initialBalance *big.Int) (common.Address, *types.Transaction, *ConstructableBasic, error) {
	parsed, err := abi.JSON(strings.NewReader(ConstructableBasicABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(ConstructableBasicBin), backend, initialAccount, initialBalance)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &ConstructableBasic{ConstructableBasicCaller: ConstructableBasicCaller{contract: contract}, ConstructableBasicTransactor: ConstructableBasicTransactor{contract: contract}, ConstructableBasicFilterer: ConstructableBasicFilterer{contract: contract}}, nil
}

// ConstructableBasic is an auto generated Go binding around an Ethereum contract.
type ConstructableBasic struct {
	ConstructableBasicCaller     // Read-only binding to the contract
	ConstructableBasicTransactor // Write-only binding to the contract
	ConstructableBasicFilterer   // Log filterer for contract events
}

// ConstructableBasicCaller is an auto generated read-only Go binding around an Ethereum contract.
type ConstructableBasicCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ConstructableBasicTransactor is an auto generated write-only Go binding around an Ethereum contract.
type ConstructableBasicTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ConstructableBasicFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type ConstructableBasicFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ConstructableBasicSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type ConstructableBasicSession struct {
	Contract     *ConstructableBasic // Generic contract binding to set the session for
	CallOpts     bind.CallOpts       // Call options to use throughout this session
	TransactOpts bind.TransactOpts   // Transaction auth options to use throughout this session
}

// ConstructableBasicCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type ConstructableBasicCallerSession struct {
	Contract *ConstructableBasicCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts             // Call options to use throughout this session
}

// ConstructableBasicTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type ConstructableBasicTransactorSession struct {
	Contract     *ConstructableBasicTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts             // Transaction auth options to use throughout this session
}

// ConstructableBasicRaw is an auto generated low-level Go binding around an Ethereum contract.
type ConstructableBasicRaw struct {
	Contract *ConstructableBasic // Generic contract binding to access the raw methods on
}

// ConstructableBasicCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type ConstructableBasicCallerRaw struct {
	Contract *ConstructableBasicCaller // Generic read-only contract binding to access the raw methods on
}

// ConstructableBasicTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type ConstructableBasicTransactorRaw struct {
	Contract *ConstructableBasicTransactor // Generic write-only contract binding to access the raw methods on
}

// NewConstructableBasic creates a new instance of ConstructableBasic, bound to a specific deployed contract.
func NewConstructableBasic(address common.Address, backend bind.ContractBackend) (*ConstructableBasic, error) {
	contract, err := bindConstructableBasic(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &ConstructableBasic{ConstructableBasicCaller: ConstructableBasicCaller{contract: contract}, ConstructableBasicTransactor: ConstructableBasicTransactor{contract: contract}, ConstructableBasicFilterer: ConstructableBasicFilterer{contract: contract}}, nil
}

// NewConstructableBasicCaller creates a new read-only instance of ConstructableBasic, bound to a specific deployed contract.
func NewConstructableBasicCaller(address common.Address, caller bind.ContractCaller) (*ConstructableBasicCaller, error) {
	contract, err := bindConstructableBasic(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &ConstructableBasicCaller{contract: contract}, nil
}

// NewConstructableBasicTransactor creates a new write-only instance of ConstructableBasic, bound to a specific deployed contract.
func NewConstructableBasicTransactor(address common.Address, transactor bind.ContractTransactor) (*ConstructableBasicTransactor, error) {
	contract, err := bindConstructableBasic(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &ConstructableBasicTransactor{contract: contract}, nil
}

// NewConstructableBasicFilterer creates a new log filterer instance of ConstructableBasic, bound to a specific deployed contract.
func NewConstructableBasicFilterer(address common.Address, filterer bind.ContractFilterer) (*ConstructableBasicFilterer, error) {
	contract, err := bindConstructableBasic(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &ConstructableBasicFilterer{contract: contract}, nil
}

// bindConstructableBasic binds a generic wrapper to an already deployed contract.
func bindConstructableBasic(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(ConstructableBasicABI))
	if err != nil {
		return nil, err
	}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_ConstructableBasic *ConstructableBasicRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _ConstructableBasic.Contract.ConstructableBasicCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ConstructableBasic *ConstructableBasicRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ConstructableBasic.Contract.ConstructableBasicTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ConstructableBasic *ConstructableBasicRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _ConstructableBasic.Contract.ConstructableBasicTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_ConstructableBasic *ConstructableBasicCallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _ConstructableBasic.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ConstructableBasic *ConstructableBasicTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ConstructableBasic.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ConstructableBasic *ConstructableBasicTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _ConstructableBasic.Contract.contract.Transact(opts, method, params...)
}
...
//
// Solidity: function totalSupply() constant returns(uint256)
func (_ConstructableBasic *ConstructableBasicCaller) TotalSupply(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _ConstructableBasic.contract.Call(opts, out, "totalSupply")
	return *ret0, err
}
...
//
// Solidity: function totalSupply() constant returns(uint256)
func (_ConstructableBasic *ConstructableBasicSession) TotalSupply() (*big.Int, error) {
	return _ConstructableBasic.Contract.TotalSupply(&_ConstructableBasic.CallOpts)
}

// TotalSupply is a free data retrieval call binding the contract method 0x18160ddd.
//
// Solidity: function totalSupply() constant returns(uint256)
func (_ConstructableBasic *ConstructableBasicCallerSession) TotalSupply() (*big.Int, error) {
	return _ConstructableBasic.Contract.TotalSupply(&_ConstructableBasic.CallOpts)
}
...
//
// Solidity: function transfer(to address, value uint256) returns(bool)
func (_ConstructableBasic *ConstructableBasicTransactor) Transfer(opts *bind.TransactOpts, to common.Address, value *big.Int) (*types.Transaction, error) {
	return _ConstructableBasic.contract.Transact(opts, "transfer", to, value)
}

// Transfer is a paid mutator transaction binding the contract method 0xa9059cbb.
//
// Solidity: function transfer(to address, value uint256) returns(bool)
func (_ConstructableBasic *ConstructableBasicSession) Transfer(to common.Address, value *big.Int) (*types.Transaction, error) {
	return _ConstructableBasic.Contract.Transfer(&_ConstructableBasic.TransactOpts, to, value)
}

// Transfer is a paid mutator transaction binding the contract method 0xa9059cbb.
//
// Solidity: function transfer(to address, value uint256) returns(bool)
func (_ConstructableBasic *ConstructableBasicTransactorSession) Transfer(to common.Address, value *big.Int) (*types.Transaction, error) {
	return _ConstructableBasic.Contract.Transfer(&_ConstructableBasic.TransactOpts, to, value)
}

// ConstructableBasicTransferIterator is returned from FilterTransfer and is used to iterate over the raw logs and unpacked data for Transfer events raised by the ConstructableBasic contract.
type ConstructableBasicTransferIterator struct {
	Event *ConstructableBasicTransfer // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ConstructableBasicTransferIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ConstructableBasicTransfer)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ConstructableBasicTransferIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ConstructableBasicTransferIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ConstructableBasicTransfer represents a Transfer event raised by the ConstructableBasic contract.
type ConstructableBasicTransfer struct {
	From  common.Address
	To    common.Address
	Value *big.Int
	Raw   types.Log // Blockchain specific contextual infos
...
//
// Solidity: e Transfer(from indexed address, to indexed address, value uint256)
func (_ConstructableBasic *ConstructableBasicFilterer) FilterTransfer(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*ConstructableBasicTransferIterator, error) {
	...
	logs, sub, err := _ConstructableBasic.contract.FilterLogs(opts, "Transfer", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &ConstructableBasicTransferIterator{contract: _ConstructableBasic.contract, event: "Transfer", logs: logs, sub: sub}, nil
}

// WatchTransfer is a free log subscription operation binding the contract event 0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef.
//
// Solidity: e Transfer(from indexed address, to indexed address, value uint256)
func (_ConstructableBasic *ConstructableBasicFilterer) WatchTransfer(opts *bind.WatchOpts, sink chan<- *ConstructableBasicTransfer, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ConstructableBasic.contract.WatchLogs(opts, "Transfer", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ConstructableBasicTransfer)
				if err := _ConstructableBasic.contract.UnpackLog(event, "Transfer", log); err != nil {
					return err
				}
				event.Raw = log
