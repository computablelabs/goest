...
func TestTotalSupply(t *testing.T) {
	...
	if supply, _ := deployed.Contract.TotalSupply(nil); supply.Cmp(big.NewInt(1000000)) != 0 {
...
func TestBalanceOf(t *testing.T) {
	...
	if userBal.Cmp(big.NewInt(100000)) != 0 {
		t.Errorf("Expected user balance of 100000, got %v", userBal)
	}
	...
	if ownerBal.Cmp(big.NewInt(900000)) != 0 {
		t.Errorf("Expected owner balance of 900000, got %v", ownerBal)
	}
}
