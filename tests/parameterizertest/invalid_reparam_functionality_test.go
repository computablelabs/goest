...
func TestInvalidSpread(t *testing.T) {
	...
	_, err := deployed.ParameterizerContract.Reparameterize(test.GetTxOpts(context.AuthUser1, nil,
		big.NewInt(test.ONE_GWEI*2), 500000), test.SPREAD, big.NewInt(50))
	test.IfNotNil(t, err, fmt.Sprintf("Error creating proposal: %v", err))

	context.Blockchain.Commit()

	// we should see a candidate now
	paramHash, _ := deployed.ParameterizerContract.GetHash(nil, test.SPREAD, big.NewInt(50))
...
func TestInvalidStake(t *testing.T) {
	...
	_, err := deployed.ParameterizerContract.Reparameterize(test.GetTxOpts(context.AuthUser1, nil,
		...
		big.NewInt(test.ONE_GWEI*2), 500000), test.STAKE, big.NewInt(test.ONE_ETH*2))
	test.IfNotNil(t, err, fmt.Sprintf("Error creating proposal: %v", err))
...
func TestInvalidStakeZero(t *testing.T) {
	// auth memeber must stake reparam...
	transErr := test.MaybeTransferMarketToken(context, deployed, context.AuthOwner, context.AuthUser1.From,
		big.NewInt(test.ONE_GWEI))
	test.IfNotNil(t, transErr, "Error maybe transferring market tokens")
	...
	// Stake must be > 0
	_, err := deployed.ParameterizerContract.Reparameterize(test.GetTxOpts(context.AuthUser1, nil,
		// Attempt to set the stake to 0 MarketToken
		big.NewInt(test.ONE_GWEI*2), 500000), test.STAKE, big.NewInt(0))
	test.IfNotNil(t, err, fmt.Sprintf("Error creating proposal: %v", err))
	context.Blockchain.Commit()

	// we should see a candidate now
	paramHash, _ := deployed.ParameterizerContract.GetHash(nil, big.NewInt(1), big.NewInt(0))
	isCan, _ := deployed.VotingContract.IsCandidate(nil, paramHash)
...
func TestInvalidVoteByTooLong(t *testing.T) {
	...
	_, err := deployed.ParameterizerContract.Reparameterize(test.GetTxOpts(context.AuthUser1, nil,
		big.NewInt(test.ONE_GWEI*2), 500000), test.VOTE_BY, big.NewInt(1500000))
	test.IfNotNil(t, err, fmt.Sprintf("Error creating proposal: %v", err))
...
func TestInvalidVoteByTooShort(t *testing.T) {
	...
	_, err := deployed.ParameterizerContract.Reparameterize(test.GetTxOpts(context.AuthUser1, nil,
		big.NewInt(test.ONE_GWEI*2), 500000), test.VOTE_BY, big.NewInt(test.MIN_VOTE_BY/2))
	test.IfNotNil(t, err, fmt.Sprintf("Error creating proposal: %v", err))
...
func TestInvalidPlurality(t *testing.T) {
	...
	_, err := deployed.ParameterizerContract.Reparameterize(test.GetTxOpts(context.AuthUser1, nil,
		big.NewInt(test.ONE_GWEI*2), 500000), test.PLURALITY, big.NewInt(150))
	test.IfNotNil(t, err, fmt.Sprintf("Error creating proposal: %v", err))
...
func TestInvalidMakerPayment(t *testing.T) {
	...
	_, err := deployed.ParameterizerContract.Reparameterize(test.GetTxOpts(context.AuthUser1, nil,
		big.NewInt(test.ONE_GWEI*2), 500000), test.MAKER_PAYMENT, big.NewInt(90))
	test.IfNotNil(t, err, fmt.Sprintf("Error creating proposal: %v", err))
...
func TestInvalidBackendPayment(t *testing.T) {
	...
	_, err := deployed.ParameterizerContract.Reparameterize(test.GetTxOpts(context.AuthUser1, nil,
		big.NewInt(test.ONE_GWEI*2), 500000), test.BACKEND_PAYMENT, big.NewInt(60))
	test.IfNotNil(t, err, fmt.Sprintf("Error creating proposal: %v", err))
